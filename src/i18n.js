...
const STRINGS = {
  en: {
    ...
    askFollowersOrder:   'Followers sort order:',
    followersOrderLatest:'Newest first',
    followersOrderOldest:'Oldest first',
    ...
    savedFollowers:      n => `Saved ${n} followers -> followers.json`,
    savedFollowing:      n => `Saved ${n} following -> following.json`,
    partialFollowersWarn:(got, total) => `Note: ${got} of ${total} followers downloaded (Instagram excludes deactivated/blocked accounts from the list)`,
    partialFollowingWarn:(got, total) => `Note: ${got} of ${total} following downloaded (Instagram excludes deactivated/blocked accounts from the list)`,
    limitFollowersWarn:  (got, total) => `Note: download truncated at ${got} of ${total} followers (internal tool limit of 5000)`,
    limitFollowingWarn:  (got, total) => `Note: download truncated at ${got} of ${total} following (internal tool limit of 5000)`,
  ...
  es: {
    ...
    askFollowersOrder:   'Orden de seguidores:',
    followersOrderLatest:'Más nuevos primero',
    followersOrderOldest:'Más viejos primero',
    fetchingFollowers:   'Obteniendo seguidores...',
    fetchingFollowing:   'Obteniendo seguidos...',
    savedComments:       (n, p) => `Se guardaron ${n} comentarios de ${p} publicaciones -> comments.json`,
    savedFollowers:      n => `Se guardaron ${n} seguidores -> followers.json`,
    savedFollowing:      n => `Se guardaron ${n} seguidos -> following.json`,
    partialFollowersWarn:(got, total) => `Nota: se descargaron ${got} de ${total} seguidores (Instagram excluye cuentas desactivadas/bloqueadas de la lista)`,
    partialFollowingWarn:(got, total) => `Nota: se descargaron ${got} de ${total} seguidos (Instagram excluye cuentas desactivadas/bloqueadas de la lista)`,
    limitFollowersWarn:  (got, total) => `Nota: descarga truncada en ${got} de ${total} seguidores (límite interno de la herramienta: 5000)`,
    limitFollowingWarn:  (got, total) => `Nota: descarga truncada en ${got} de ${total} seguidos (límite interno de la herramienta: 5000)`,
