...
- [x] Task A2: Add `formatTs(ts, formatType)` helper
...
- [x] Task B1: Update filename format in `runMediaDownload`
...
- [x] Task B2: Add `taken_at` to caption JSON output
...
- [x] Task C1: Compute summary date fields in `extractProfile`
...
- [x] Task C2: Add date rows to `printSummary`
